...
void Thread1Func(void *argument);
void Thread2Func(void *argument);
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of Thread1 */
  Thread1Handle = osThreadNew(Thread1Func, NULL, &Thread1_attributes);

  /* creation of Thread2 */
  Thread2Handle = osThreadNew(Thread2Func, NULL, &Thread2_attributes);
